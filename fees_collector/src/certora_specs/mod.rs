...
use crate::certora_specs::permissions::{
    ...
    permissions_emergency_admin_role_changes,
    permissions_rewards_admin_role_changes,
    permissions_operations_admin_role_changes,
    permissions_pause_admin_role_changes,
    permissions_emergency_pause_admins_changes,
    // Transfer deadlines
...
// Generate rules in parametric style for access control permissions - organized by GhostState variables

// Role addresses
parametric_rule!(permissions_admin_role_changes);
parametric_rule!(permissions_emergency_admin_role_changes);
parametric_rule!(permissions_rewards_admin_role_changes);
parametric_rule!(permissions_operations_admin_role_changes);
parametric_rule!(permissions_pause_admin_role_changes);
parametric_rule!(permissions_emergency_pause_admins_changes);
